...
var VueGoodPagination = { render: function () {
  ...
  props: {
    ...
    perPage: {},
    rtl: { default: false },
    customRowsPerPageDropdown: { default: function default$1() {
        return [];
      } },
...
var date = lodash_clone(defaultType);
...
var number = lodash_clone(defaultType);
    ...
    processedRows: function processedRows() {
      ...
      if (this.globalSearchAllowed) {
        ...
        lodash_foreach(allRows, function (row) {
          lodash_foreach(this$1.columns, function (col) {
